...
public class CreateBranchCommandHandler : IRequestHandler<CreateBranchCommand, SysResult>
{
    ...
    public async Task<SysResult> Handle(CreateBranchCommand request, CancellationToken cancellationToken)
    {

...
namespace Infrastructure.SmsServices
{
    public class KavenegarSmsSenderService : IKavenegarSmsSenderService, IScoped
    {
        ...
        //******************************************************************************************************************** 
        public KavenegarSmsSenderService(IHttpRestClient restClient)
        {
            _restClient = restClient;
        }
        //******************************************************************************************************************** 
        public async Task<SysResult> Send(string apiKey, string senderLine, string MobileNumber, string Message)
        {
            var response = await _restClient.Send<object>(new ApiRequest()
            {
                ApiType = ApiType.POST,
                Data = SmsResquestGenarator(senderLine, MobileNumber, Message),
                Url = baseUrl + apiKey + "/sms/send.json",
        ...
        //******************************************************************************************************************** 
        KavenegarRequest SmsResquestGenarator(string senderLine, string MobileNumber, string Message)
        {

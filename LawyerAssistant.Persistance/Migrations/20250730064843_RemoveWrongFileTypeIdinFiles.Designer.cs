...
namespace LawyerAssistant.Persistance.Migrations
{
    ...
    [Migration("20250730064843_RemoveWrongFileTypeIdinFiles")]
    partial class RemoveWrongFileTypeIdinFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LawyerAssistant.Domain.Aggregates.SMSCenterModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LawyerAssistant.Domain.Aggregates.SMSCenterModel", b =>
                {
                    b.HasOne("LawyerAssistant.Domain.Aggregates.ReActionModel", "Reaction")
                        .WithMany("SMSCenters")
